...
public class Principal extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (JOptionPane.OK_OPTION == resp) {
            ...
            tm.recibeMemorias(numMemorias);
            String area = tm.execute();
    ...
    private void btncodificaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncodificaActionPerformed
        ...
        List<String> binSecEstCod = tm.codificarPalabra(binario);
        TFImprimebinario.setText(binSecEstCod.get(0));
        TFImprimebinario.setEditable(Boolean.TRUE);
        TFEstados.setText(binSecEstCod.get(1));
        TFEstados.setEditable(Boolean.TRUE);
        TFIpalabracod.setText(binSecEstCod.get(2));
